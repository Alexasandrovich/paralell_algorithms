...
int main()
{
    ...
    {
        watch_1 = clock();
        double a1 = summ_just(N, alpha1);
        watch_2 = clock();
        cout << alpha1 << ";" << (watch_2 - watch_1) / double(CLOCKS_PER_SEC) << endl;
    }
    ...
    for (double i = 1; i < 100; i++)
    {
        thr1 += 20;
        watch_1 = clock();
        double a2 = summ_parallel(N, alpha, thr1);
        watch_2 = clock();
        cout << thr1 << ";" << (watch_2 - watch_1) / double(CLOCKS_PER_SEC) << endl;
    }
